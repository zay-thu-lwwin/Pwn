...
`Tcache` bin တစ်ခုစီမှာ အလွန်ဆုံး Chunk (7) ခုပဲ သိမ်းလို့ရပါတယ် အကယ်၍ Thread တစ်ခုက Size တူတာတွေကို (7) ကြိမ်ထက်မက ဆက်တိုက် `free` လိုက်ရင် `Tcache` ပြည့်သွားပြီး ကျန်တဲ့ Chunk တွေက Main Arena ရဲ့ Fast bin/Unsorted bin ဆီကို စီးဆင်းသွားပါတယ် အဲဒီအချိန်မှာ တခြား Thread တွေနဲ့ Lock သွားတိုက်ရင် Arena အသစ် ဆောက်ပါလိမ့်မယ်
