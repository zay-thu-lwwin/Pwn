...
```c
pwndbg> checksec
File:     /home/Jackfruit/cate/learn/binary/stack/tryhackme/pwn109/pwn109-1644300507645.pwn109
Arch:     amd64
RELRO:      Partial RELRO
Stack:      No canary found
NX:         NX enabled
...
NO Pie ဆိုတော့ ပျော်ပျော်ကြီးဘဲ
partial relro ဆိုတော့ got ပါ overwrite လို့ရ
stack canary လည်းမရှိတော့ စိတ်ကြိုက် overflow ပေတော့ဘဲ
...
ဒီ functionဘဲပါတယ် ဆိုတော့ 
NO pie ဆို တော့ overflow ပြီး puts နဲ့ puts got address ကို leak မယ်
`libc` base တွက် 
system function ကိုခေါ်မယ်

ဒါမဲ့ `thm` ချိတ်မရတော့ဒီမှာဘဲ ရပ်နေရတယ်
