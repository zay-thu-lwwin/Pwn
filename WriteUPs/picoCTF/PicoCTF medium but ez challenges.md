...
c code ဘဲပေးထားတယ် လွယ်တယ်
`strstr()` ကိုအသုံးချသွားတာ
computer random  ကို user inputမှာပါမပါ စစ်တယ်
ပါရယ် win++
5 ခါဆို flag ရ
script တောင်ရေးစရာမလို
1နဲ့
rockpaperscissors 
တစ်လှည့်စီချနေရုံဘဲ
...
ရိုးရိုး 32 bit bufferoverflow မှ arguments နဲ့ fake ret address ထည့်ဖို့မမေ့နဲ့
